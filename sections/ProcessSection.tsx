        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          {profileData.process.map((step, idx) => (
            <motion.div
              ...
              className="bg-white p-6 sm:p-7 rounded-2xl border border-[#E5E5DE] shadow-xs flex flex-col justify-between hover:border-accent/40 transition-colors"
            >
              <div>
                <span className="text-2xl sm:text-3xl font-display font-extrabold text-[#111111]/20 block mb-4">
                  {step.number}
                </span>
